      ...
      <div className="max-w-[1220px] mx-auto">
        <div className="flex justify-between items-center flex-wrap pb-7">
          ...
          <div className="mx-auto   ">
            <Image
              src="https://biorost.ua/assets/logo-BH7nQsao.png"
              width={200}
              height={40}
              alt="Logo"
            />
          ...
          <div className="text-xl text-center">
            <a
              ...
              className="block text-black no-underline ml-2.5 hover:text-[#2f7a2f]"
            >
              Biorost.zap@gmail.com
            </a>
            <a
              href="tel:+380687579303"
              className="block text-black no-underline ml-2.5 hover:text-[#2f7a2f]"
            >
              +380687579303
            </a>
        ...
        <div className="mt-2.5 flex justify-between items-center flex-wrap gap-2.5">
          <nav className="flex flex-wrap gap-4 text-[17px]">
            <a
              href="#"
              className="no-underline text-[#333] font-medium hover:text-[#2f7a2f]"
            >
              Про нас
            </a>
            <a
          ...
          <div className="relative flex items-center w-[270px]">
            <input
              type="text"
              placeholder="Пошук"
              className="pl-2.5 pr-8 py-1.5 border border-[#ccc]  bg-white rounded-[12px] h-[42px] focus:outline-none focus:ring-1 focus:ring-[#2f7a2f] w-full"
            />
