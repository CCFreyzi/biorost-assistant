...
export default function Chat() {
  ...
  const faqs = [
    "Які типи добрив у вас є?",
    "Які продукти використовуються при листовій обробці навесні?",
    "Які препарати застосовуються у фазу цвітіння ріпаку?",
    "Як підготувати посіви до морозів?",
  ];
                  ...
                  <div
                    ...
                    className={`mb-3 p-3 rounded-lg ${
                      m.role === "user"
                        ...
                        : "bg-white text-green-900 mr-auto border border-green-300"
                    }`}
                  >
